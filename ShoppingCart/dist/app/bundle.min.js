...
/* harmony import */ var symbol_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
...
exports.fetchProducts = exports.loading = exports.INIT_PRODUCTS = exports.updateItem = exports.removeItem = exports.empty = exports.addUserAddress = exports.addItem = undefined;
...
var addUserAddress = exports.addUserAddress = function addUserAddress(address) {
    return {
...
var updateItem = exports.updateItem = function updateItem(id, qty) {
    return {
...
var INIT_PRODUCTS = exports.INIT_PRODUCTS = function INIT_PRODUCTS(products) {
    return {
        type: "INIT_PRODUCTS",
        payload: {
            products: products
...
var loading = exports.loading = function loading(_loading) {
    return {
        type: "LOADING",
        payload: {
            loading: _loading
...
var fetchProducts = exports.fetchProducts = function fetchProducts() {
    ...
    return function (dispatch, getState) {
        ...
        window.fetch("http://localhost:9090/api/products").then(function (response) {
            return response.json();
        }).then(function (products) {
            console.log("Got products ", products);
            var action = INIT_PRODUCTS(products);
            dispatch(action);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(12), __webpack_require__(32)(module)))
...
var ADD_ITEM = exports.ADD_ITEM = "CART.ADD_ITEM";
var REMOVE_ITEM = exports.REMOVE_ITEM = "CART.REMOVE_ITEM";
var UPDATE_ITEM = exports.UPDATE_ITEM = "CART.UPDATE_ITEM";
var EMPTY_CART = exports.EMPTY_CART = "CART.EMPTY_CART";
var ADDUSER_ADDRESS = exports.ADDUSER_ADDRESS = "ADDRESS.ADDUSER";
...
var _CartItemComponent = __webpack_require__(50);
...
exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(_CartItemComponent2.default);
...
var _implementation = __webpack_require__(41);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(17),r=__webpack_require__(27);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
exports.default = (0, _redux.createStore)((0, _redux.combineReducers)({
    items: _CartReducer2.default,
    product: _ProductReducer2.default,
    address: _AddressReducer2.default
}), {}, (0, _redux.applyMiddleware)(myLogger, _reduxPromiseMiddleware2.default, _reduxThunk2.default));
...
/* harmony import */ var _isPromise_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);
    ...
    switch (action.type) {
        ...
        case ActionTypes.UPDATE_ITEM:
            return state.map(function (item) {
                ...
                // item to update
                return _extends({}, item, { qty: action.payload.qty });
            });
...
function productReducer() {
    ...
    switch (action.type) {
        ...
        case "LOADING":
            return _extends({}, state, { loading: action.payload.loading });
...
function addressReducer() {
    ...
    switch (action.type) {
        case ActionTypes.ADDUSER_ADDRESS:
            ...
            return _extends({}, state, { address: action.payload.address });
...
var _AddressContainer = __webpack_require__(46);

var _AddressContainer2 = _interopRequireDefault(_AddressContainer);

var _CheckoutContainer = __webpack_require__(48);
...
var _AboutComponent = __webpack_require__(53);
...
var _PageNotFound = __webpack_require__(61);

var _PageNotFound2 = _interopRequireDefault(_PageNotFound);

var _CartContainer = __webpack_require__(62);

var _CartContainer2 = _interopRequireDefault(_CartContainer);

var _ProductContainer = __webpack_require__(68);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    null,
                    _react2.default.createElement(_HeaderComponent2.default, { appTitle: this.state.appTitle }),
                    _react2.default.createElement(
                        _reactRouterDom.Switch,
                        null,
                        _react2.default.createElement(_reactRouterDom.Route, { path: "/", exact: true, component: _HomeComponent2.default }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: "/cart", component: _CartContainer2.default }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: "/products", component: _ProductContainer2.default }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: "/about", component: _AboutComponent2.default }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: "/checkout", component: _CheckoutContainer2.default }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: "/address", component: _AddressContainer2.default }),
                        _react2.default.createElement(_reactRouterDom.Route, { path: "*", component: _PageNotFound2.default })
                    ),
                    _react2.default.createElement(
                        _FooterComponent2.default,
                        { appTitle: this.state.appTitle, year: this.state.year },
                        _react2.default.createElement(
                            "p",
                            null,
                            "Contact time: 8:00 AM to 5:00 PM | India Contact time: 9:00 to 6:00 PM"
                        )
                    )
                )
            );
...
var _gud = __webpack_require__(42);
...
var _AddressComponent = __webpack_require__(47);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        addUserAddress: function addUserAddress(address) {
            dispatch((0, _actions.addUserAddress)(address));
        }
    };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_AddressComponent2.default);
...
var Address = function (_React$Component) {
    ...
    function Address(props) {
        ...
        _this.AddUserAddress = function () {
            ...
            _this.props.addUserAddress(address);
        };
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "text", className: "form-control col-md-6 fname", value: this.state.firstName,
                        placeholder: "First Name",
                        onChange: this.onChangeText }),
                    _react2.default.createElement("hr", null),
                    _react2.default.createElement("input", { type: "text", className: "form-control col-md-6 lname", value: this.state.lasttName,
                        placeholder: "Last Name",
                        onChange: this.onChangeText }),
                    _react2.default.createElement("hr", null),
                    _react2.default.createElement("input", { type: "text", className: "form-control col-md-6 street", value: this.state.street,
                        placeholder: "Street Name",
                        onChange: this.onChangeText }),
                    _react2.default.createElement("hr", null),
                    _react2.default.createElement("input", { type: "text", className: "form-control col-md-6 cellphone", value: this.state.cellPhone,
                        placeholder: "Cell Phone",
                        onChange: this.onChangeText }),
                    _react2.default.createElement("hr", null),
                    _react2.default.createElement("input", { type: "button", className: "btn btn-default", value: "Add User", onClick: this.AddUserAddress })
                )
            );
        }
    }]);
...
var _CheckoutComponent = __webpack_require__(49);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(_CheckoutComponent2.default);
...
var _CartItemContainer = __webpack_require__(20);

var _CartItemContainer2 = _interopRequireDefault(_CartItemContainer);
...
var Checkout = function (_React$Component) {
    ...
    _createClass(Checkout, [{
        key: "render",
        value: function render() {
            var addressPbj = this.props.address.address;
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.props.products.map(function (item) {
                                return _react2.default.createElement(_CartItemContainer2.default, { item: item,
                                    key: item.id,
                                    donotrender: true
                                });
                            })
    ...
    _createClass(CartItem, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                !this.props.donotrender ? _react2.default.createElement(
                    "td",
                    null,
                    _react2.default.createElement("input", { value: this.state.qty,
                        type: "number",
                        onChange: this.onChangeText,
                ...
                !this.props.donotrender ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { onClick: function onClick() {
                                return _this2.props.actions.updateItem(item.id, _this2.state.qty);
                            } },
                        "Update"
                    ),
                    _react2.default.createElement(
                        "button",
                        { onClick: function onClick() {
                                return _this2.props.actions.removeItem(item.id);
                            } },
                        "Remove"
                    )
                ) : ""
...
function Home() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "h1",
            null,
            "This is the home component we use"
        ),
        _react2.default.createElement("hr", null)
    );
}
...
function About() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            "h1",
            null,
            "We are team of self enthusiast and self motivated techies."
        ),
        _react2.default.createElement("hr", null)
    );
}
...
function Header(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            { to: "/", exact: true, className: "button", activeClassName: "success" },
            "Home "
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
            { to: "/cart", className: "button", activeClassName: "success" },
            "Cart  "
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
            { to: "/products", className: "button", activeClassName: "success" },
            "Product  "
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
            { to: "/checkout", className: "button", activeClassName: "success" },
            "CheckOut  "
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
            { to: "/address", className: "button", activeClassName: "success" },
            "Address  "
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
...
var _CartComponent = __webpack_require__(63);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        addItem: function addItem() {
            ...
            var action = (0, _actions.addItem)(item);
            dispatch(action);
        },
        empty: (0, _redux.bindActionCreators)(_actions.empty, dispatch)
        // empty: () =>{
        //     dispatch(empty)
        // }
    };
...
// decorator
var connectFn = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps);

var CartContainerComponent = connectFn(_CartComponent2.default);

exports.default = CartContainerComponent;
...
var _CartListContainer = __webpack_require__(64);

var _CartListContainer2 = _interopRequireDefault(_CartListContainer);

var _CartSummaryContainer = __webpack_require__(66);

var _CartSummaryContainer2 = _interopRequireDefault(_CartSummaryContainer);
...
function Cart(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_CartListContainer2.default, null),
        _react2.default.createElement(_CartSummaryContainer2.default, null)
    );
...
var _CartListComponent = __webpack_require__(65);

var _CartListComponent2 = _interopRequireDefault(_CartListComponent);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(_CartListComponent2.default);
...
var _CartSummaryComponents = __webpack_require__(67);

var _CartSummaryComponents2 = _interopRequireDefault(_CartSummaryComponents);
...
function recalculate(items) {
    ...
    return {
        amount: amount, //ES6 sugar amount: amount
        count: count
    };
}
...
var mapStateToProps = function mapStateToProps(state) {
    var result = recalculate(state.items);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(_CartSummaryComponents2.default);
...
var _ProductComponent = __webpack_require__(69);
...
function mapDispatchToProps(dispatch) {
    return {
        fetchProducts: function fetchProducts() {
            var actionFn = actions.fetchProducts();
            dispatch(actionFn);
        }
    };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_ProductComponent2.default);
...
var _ProductInfoComponent = __webpack_require__(70);

var _ProductInfoComponent2 = _interopRequireDefault(_ProductInfoComponent);
                ...
                _react2.default.createElement(
                    ...
                    products.map(function (product) {
                        return (
                            ...
                            _react2.default.createElement(_ProductInfoComponent2.default, { item: product })
                        );
                    })
                )
            );
...
var ProductInfo = function (_React$Component) {
    ...
    function ProductInfo(props) {
        ...
        _this.showDetailedInfo = function () {
